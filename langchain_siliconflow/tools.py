...
class SiliconFlowToolInput(BaseModel):
    """Input schema for SiliconFlow tool.
...
class SiliconFlowTool(BaseTool):  # type: ignore[override]
    """SiliconFlow tool.
    ...
    args_schema: Type[BaseModel] = SiliconFlowToolInput

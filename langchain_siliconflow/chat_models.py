...
class ChatSiliconFlow(BaseChatModel):
    ...
    Key init args — client params:
        ...
        api_key: Optional[str]
            SiliconFlow API key. If not passed in will be read from env var SILICONFLOW_API_KEY.
    ...
    Tool calling:
        ...
        See ``ChatSiliconFlow.bind_tools()`` method for more.
    ...
    Structured output:
        ...
        See ``ChatSiliconFlow.with_structured_output()`` for more.
    ...
    # TODO: Implement if ChatSiliconFlow supports async streaming. Otherwise delete.
    # async def _astream(
    #     self,
    #     messages: List[BaseMessage],
    #     stop: Optional[List[str]] = None,
    ...
    # TODO: Implement if ChatSiliconFlow supports async generation. Otherwise delete.
